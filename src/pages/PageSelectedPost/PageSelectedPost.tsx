        ...
        <>
            ...
            <div className="selected-post-container">
                <div className="selected-post-wrapper">
                    ...
                    <Button buttonStyle='button-back-home'>Home</Button>
                    <Title withAltMargins={true} >Astronauts prep for new solar arrays on nearly seven-hour spacewalk</Title>

                    <div className="article">
                        <img src={Astronaut} alt="Article's image" className="article__image" />
                    ...
                    <DownNavigationBar withPagination= {false}></DownNavigationBar>
